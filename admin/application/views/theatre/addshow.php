<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url(); ?>theatre/addshow"><i class="fa fa-dashboard"></i>Show</a></li>
    ...
    <section class="content">
       <div class="box box-info">
            ...
            <form class="form-horizontal" method="post" data-parsley-validate="" class="validate">
             ...
             <div class="col-sm-5">
                    <select class="form-control" style="width: 100%;" name="cinemas_id" id="theatre" required>
          ...
          <span class="glyphicon  form-control-feedback"></span>
             ...
             <div class="col-sm-5">
                    <select class="form-control" style="width: 100%;" name="movie_name_id" id="movie" requires>
                    <?php
          ...
          <span class="glyphicon  form-control-feedback"></span>
             ...
             <div class="col-sm-5">
                    <select class="form-control" style="width: 100%;" name="screen_name" id="screen" required>
                    <?php
                      foreach ($screen as $value) { ?>
                       <option value="<?php echo $value->screen_name;?>"><?php echo $value->screen_name;?></option>
                        <?php
                      }
                    ?>
                    </select>
          ...
          <span class="glyphicon  form-control-feedback"></span>
                ...
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-3">Time</label>
                    <div class="col-sm-5" id="xyz">
                  <div class="input-group">
                    <input type="text" class="form-control timepicker" name="screen_timing[]" required>
                  ...
                  <div class="square col-sm-4" id="showsquare" style="margin-top:10px"> <i class="fa fa-plus-square">&nbsp;Add</i></div>
                </div>
