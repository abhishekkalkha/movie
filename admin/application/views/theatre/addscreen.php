<div class="content-wrapper" ng-app="ticket" ng-controller="ticketCtrl">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url(); ?>theatre/addscreen"><i class="fa fa-dashboard"></i>Screen</a></li>
    ...
    <section class="content">
       <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal form-label-left" data-parsley-validate="" id="theater_form" novalidate="" name="theater_align_form" ng-submit=" theater_align_fun()" method="post">
              <div class="box-body">
     ...
     <div class="item form-group">
              ...
              <div class="box-footer">
               ...
               <!--  <button type="submit" class="btn btn-default">Cancel</button> -->
                   <button type="button" ng-click="theater_align_fun(theater_align_form)" class="btn btn-info pull-right">Add</button>
                </div>               
              </div>
              <!-- /.box-footer -->
            </form>
        ...
        <div class="modal fade"  ng-show="theater_design"  aria-labelledby="myModalLabel" aria-hidden="false" id="myModal" data-backdrop="static" data-keyboard="false">
                          ...
                          <div class="form-group">
                              <div class="col-md-12 col-sm-12 col-xs-12 ">
                                <!--   <button class="btn btn-primary pull-right" type="button" ng-click="theater_preview_html=false;theater_design=false">Cancel</button> -->
                                 <button type="button" class="btn btn-default pull-right" data-dismiss="modal" ng-click="close_button()">Close</button>
         ...
         <div class="modal fade"  ng-show="theater_preview_html"  aria-labelledby="myModalLabel" aria-hidden="false" id="myModal2" data-backdrop="static" data-keyboard="false">
          ...
          <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close" ng-click="theater_preview_html=false;theater_design=true">
                  <span aria-hidden="true">&times;</span></button>
