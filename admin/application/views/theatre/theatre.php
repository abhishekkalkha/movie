<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url(); ?>theatre/create"><i class="fa fa-dashboard"></i>Theatres</a></li>
    ...
    <section class="content">
       <div class="box box-info">
            ...
            <form class="form-horizontal" method="post" data-parsley-validate="" class="validate">
             ...
             <div class="col-sm-5">
                    <input type="text" class="form-control" id="title" name="theater_name" placeholder="Input title" required="">
          ...
          <span class="glyphicon  form-control-feedback"></span>
             ...
             <div class="col-sm-5">
                    <input type="text" class="form-control" id="latitude" name="latitude" placeholder="Input latitude" required="">
                    <span class="glyphicon  form-control-feedback"></span>
             ...
             <div class="col-sm-5">
                    <input type="text" class="form-control" id="longitude" name="longitude" placeholder="Input logitude" required="">
                    <span class="glyphicon  form-control-feedback"></span>
                </div>
              </div>
