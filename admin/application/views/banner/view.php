             ...
             <?php
               ...
               foreach ($list as $result) { 
                ...
                <tr>
                     ...
                     <td><?php echo $i;?></td>
                    <td><img src="<?php echo base_url();?><?php echo $result->banner_images;?> " width="30" height="30"></td>
                  <!--        <td>
                      <?php
                      if( $result->status=='0'){?>
                    ...
                    <td>     
                         <a class="btn btn-sm btn-danger" href="<?php echo base_url();?>banners/delete_image/<?php echo $result->id; ?>" onClick="return doconfirm()">
