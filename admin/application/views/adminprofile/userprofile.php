               ...
               <!-- form start -->
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group has-feedback">
                      ...
                      <input type="text" class="form-control required" name="name" value="<?php echo $data->name; ?>" id="name" data-parsley-pattern="^[a-zA-Z\  \/]+$" placeholder="Enter your name" data-parsley-minlength="3" data-parsley-maxlength="25" required =" " >
