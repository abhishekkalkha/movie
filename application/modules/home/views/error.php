...
?>
		...
		<div class="tb-top-left">
			...
			<a href="<?php echo base_url();?>"><img ng-src="<?php echo base_url('code/').$logo;?>" width="50px;height:50px;"></a>
		...
		<!-- LOGGED-OUT -->
			...
			<div class="tb-logged-out" ng-hide="sign_data">
			...
			<div class="tb-logged-in" ng-show="sign_data">

				<ul>

					<li><a href="#" data-toggle="modal" data-target="#myaccount" style="padding:0px;">{{sign_data.first_name+' '+sign_data.last_name}}</li>
    ...
    <nav class="tb-navbar navbar-inverse">
		...
		<div class="container">
			...
			<div class="navbar-header tb-nav-header">
				...
				<a href="<?php echo base_url();?>"><img ng-src="<?php echo base_url('code/').$logo;?>" width="180px;height:73px;"></a>
				...
				<div class="modal-body tb-myaccount-pop-body">
					...
					<div class="tb-myaccount-pop-head">
						...
						<div class="tb-myaccnt-wel">
							...
							<p>{{sign_data.first_name+' '+sign_data.last_name}}</p>
							...
							<div id="nwshwng" class="tab-pane fade in active border-none">
								...
								<ul>
									...
									<li ng-repeat="trailerdetails in trailermovie | filter:languagemovieFilter">
										...
										<img ng-src="{{go_image_path(trailerdetails.image)}}">
							...
							<div id="cmngsoon" class="tab-pane fade border-none">
								...
								<ul>
									...
									<li ng-repeat="commingsoondetails in trailercommingsoon | filter:languagemovieFilter">
	    								...
	    								<img ng-src="{{go_image_path(commingsoondetails.image)}}">
...
<div style="width:100%;padding-top:117px;text-align:center;"><img src="<?php echo base_url('assets\public\img\404.jpg'); ?>"></div>