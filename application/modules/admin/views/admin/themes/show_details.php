                        ...
                        <div class="modal-body">
                          ...
                          <form name="edit_form" ng-submit="edit_form_submitted && add_booking(cinema)"  ng-init="form_edit_table='<?php //echo $table;?>'">
						    ...
						    <div class="col-md-12 col-sm-12 col-xs-12 my-row"  >
                              <div class="item form-group" ng-class="{'bad' : edit_form_submitted && edit_form.movie_name_id.$error.required}">
                                <label for="movie_name_id" class="control-label col-md-3 col-sm-3 col-xs-12">Movie Name<span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" ng-model="cinema.movie_name_id" class="form-control col-md-7 col-xs-12 " required="required" name="movie_name_id" >
                                </div>
                                <span class="alert" ng-show="edit_form_submitted && edit_form.movie_name_id.$error.required">This field is required</span>
                              </div>
                            </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 my-row"  >
                              <div class="item form-group" ng-class="{'bad' : edit_form_submitted && edit_form.screen_name.$error.required}">
                                <label for="screen" class="control-label col-md-3 col-sm-3 col-xs-12">Screen Name<span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" ng-model="cinema.screen_name" class="form-control col-md-7 col-xs-12 " required="required" name="screen_name" >
                                </div>
                                <span class="alert" ng-show="edit_form_submitted && edit_form.screen_name.$error.required">This field is required</span>
                              </div>
                            </div>
                    ...
                    <tbody>
                      ...
                      foreach ($content as $key => $value) {?>
                        <tr style="text-align:center">
                          ...
                          <td><?php echo $value->movie_name_id;?></td>
